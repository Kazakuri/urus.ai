...
pub fn create(msg: CreateUser) -> <CreateUser as Message>::Result {
  ...
  let id = Uuid::parse_str("00000000000000000000000000000002").expect("Invalid UUID provided");
  ...
  let token = UserToken {
    id: Uuid::parse_str("00000000000000000000000000000006").expect("Invalid UUID provided"),
    user_id: id,
