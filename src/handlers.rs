...
pub fn handlers(app: &mut ServiceConfig) {
    debug(app)
        ...
        .service(web::resource("/logout").route(web::get().to_async(api::session::delete)))
        .service(
            web::resource("/register")
                .route(web::get().to_async(app::register))
                .route(web::post().to_async(api::user::create)),
        )
        .service(web::resource("/profile").route(web::get().to_async(app::profile::urls)))
        .service(web::resource("/profile/urls").route(web::get().to_async(app::profile::urls)))
        .service(
            web::resource("/profile/account").route(web::get().to_async(app::profile::account)),
        )
        .service(
...
fn debug(app: &mut ServiceConfig) -> &mut ServiceConfig {
    app.service(Files::new("/res", "./public"))
        .service(web::resource("/favicon.ico").route(web::get().to(|| file("public/favicon.ico"))))
        .service(web::resource("/robots.txt").route(web::get().to(|| file("public/robots.txt"))))
        .service(web::resource("/sitemap.xml").route(web::get().to(|| file("public/sitemap.xml"))))
}
